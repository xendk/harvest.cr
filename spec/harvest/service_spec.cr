...
describe Harvest::Service do
  context "#get" do
    it "supports pagination" do
      WebMock.stub(:get, "https://api.harvestapp.com/v2/time_entries?from=2024-05-17")
        ...
        .to_return(body: %({"time_entries":[{"id":123456,"spent_date":"2024-05-18","hours":1.1,"rounded_hours":1.25,"notes":"Doing something","is_closed":false,"is_billed":false,"timer_started_at":null,"billable":true,"created_at":"2024-05-18T16:51:35Z","updated_at":"2024-05-18T16:51:44Z","user":{"id":456,"name":"The Tester"},"client":{"id":789,"name":"The Client","currency":"DKK"},"project":{"id":147,"name":"The Project","code":"PROJ"},"task":{"id":258,"name":"The task"}}],"links": {"next": "https://api.harvestapp.com/v2/time_entries?cursor=banana"}}))
      WebMock.stub(:get, "https://api.harvestapp.com/v2/time_entries?cursor=banana")
        .with(headers: expected_headers)
        .to_return(body: %({"time_entries":[{"id":654321,"spent_date":"2024-05-18","hours":1.1,"rounded_hours":1.25,"notes":"Doing something","is_closed":false,"is_billed":false,"timer_started_at":null,"billable":true,"created_at":"2024-05-18T16:51:35Z","updated_at":"2024-05-18T16:51:44Z","user":{"id":456,"name":"The Tester"},"client":{"id":789,"name":"The Client","currency":"DKK"},"project":{"id":147,"name":"The Project","code":"PROJ"},"task":{"id":258,"name":"The task"}}],"links": {"next": null}}))
  ...
  context "#time_entries" do
    it "fetches time entries" do
      ...
      result[0].billable.should eq true
